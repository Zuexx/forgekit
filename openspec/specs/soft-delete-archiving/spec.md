# soft-delete-archiving Specification

## Purpose
Defines the soft-delete and restore pattern for BaseEntity records, including restore eligibility, query-filter behavior, sample TodoService integration, and audit preservation.
## Requirements
...
**Acceptance Criteria:**
- Class MUST be located in ForgeKit.Api/Domain/Services/SoftDeleteDomainService.cs
