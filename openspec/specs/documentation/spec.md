...
## Purpose
Defines XML documentation generation, comment standards, Scalar/OpenAPI integration, and review expectations.
## Requirements
...
**Specification:**
- `<GenerateDocumentationFile>true</GenerateDocumentationFile>` in ForgeKit.Api.csproj
