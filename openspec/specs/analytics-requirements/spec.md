...
## Purpose
Defines analytics model requirements for workspace rollups and daily activity snapshots.
## Requirements
...
**Acceptance Criteria:**
- Entity MUST be located in `ForgeKit.Api/Entities/Analytics/WorkspaceAnalytics.cs`
...
**Acceptance Criteria:**
- Entity MUST be located in `ForgeKit.Api/Entities/Analytics/DailyActivitySnapshot.cs`
- Entity MUST inherit from `BaseEntity`
